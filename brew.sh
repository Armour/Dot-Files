brew tap buo/cask-upgrade homebrew/science homebrew/services
brew update
brew upgrade

# install brew stuff
brew install autojump docker-clean heroku libpng mono nginx node postgresql redis yarn wget python python3 sqlmap taglib tree ccat archey colordiff stormssh htop
...
brew cask install wireshark texmaker mactex skype spotify appcode clion pycharm webstorm clip-studio-paint telegram insomnia kaleidoscope now dashlane
